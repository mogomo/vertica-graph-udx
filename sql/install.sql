...
CREATE OR REPLACE TRANSFORM FUNCTION vgraph.gcomponents_count AS LANGUAGE 'C++' NAME 'GComponentsCountFactory' LIBRARY vgraph :fenced;
...
GRANT EXECUTE ON TRANSFORM FUNCTION vgraph.gcomponents_count(INT, INT, INT, INT, BOOLEAN, FLOAT, INT, INT) TO PUBLIC;
